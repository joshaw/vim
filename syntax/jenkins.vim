...
syn keyword jenkinsfileCoreStep dockerfile skipwhite nextgroup=jenkinsFileDockerfileConfigBlock
...
syn keyword jenkinsfileCoreStep post always changed fixed failure success unstable aborted
...
syn region  jenkinsFileDockerfileConfigBlock contained start='{' end='}' contains=groovyString,jenkinsfileDockerfileKeyword transparent
syn keyword jenkinsFileDockerfileKeyword contained dir filename args additionalBuildArgs
...
syn keyword jenkinsfilePipelineStep splitTests springBoot sscm sseBuild sseBuildAndPublish sshCommand sshPut sshGet sshPublisher sshagent stage
...
hi link jenkinsFileDockerFileKeyword jenkinsfilePipelineStep
